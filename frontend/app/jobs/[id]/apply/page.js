...
export default function ApplyForJob() {
  ...
  return (
    <div className="flex min-h-screen bg-[#F4F7F9] font-sans">
      {/* SIDEBAR */}
      <aside className="w-[230px] bg-[#0A1D27] text-white flex flex-col justify-between select-none shrink-0">
        <div>
          {/* Logo */}
          <div className="flex items-center gap-2 px-6 py-7">
            <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-blue-500 to-emerald-400 flex items-center justify-center shrink-0">
              <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
              </svg>
            </div>
            <span className="font-bold text-lg">
              Trustly<span className="text-[#1FB6C9]">Hub</span>
            </span>
          </div>
